...
class Game(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.count = 4
        self.end = 0
        men = QtWidgets.QPushButton('В меню' ,self)
        men.setStyleSheet("background-color: red; color: white")
        men.clicked.connect(gomenu)
        ...
        if Setting.protiv == 0:
            vs.setText('Режим:игрок против против компьютера')
        else:
        ...
        nad.addWidget(men, 0, 0, alignment=QtCore.Qt.AlignmentFlag.AlignLeft)
    ...
    def field1(self):
        ...
        def el11enter(q):
            self.el1_1.setIcon(QtGui.QIcon('E:\monetka2.png'))
        def el11leave(q):
            self.el1_1.setIcon(QtGui.QIcon('E:\monetka.png'))
        def el21enter(q):
            self.el2_1.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el2_2.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el2_3.setIcon(QtGui.QIcon('E:\monetka2.png'))
        def el21leave(q):
            self.el2_1.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el2_2.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el2_3.setIcon(QtGui.QIcon('E:\monetka.png'))
        def el22enter(q):
            self.el2_2.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el2_3.setIcon(QtGui.QIcon('E:\monetka2.png'))
        def el22leave(q):
        ...
        def el23leave(q):
            self.el2_3.setIcon(QtGui.QIcon('E:\monetka.png'))
        def el31enter(q):
            self.el3_1.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el3_2.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el3_3.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el3_4.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el3_5.setIcon(QtGui.QIcon('E:\monetka2.png'))
        def el31leave(q):
            self.el3_1.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el3_2.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el3_3.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el3_4.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el3_5.setIcon(QtGui.QIcon('E:\monetka.png'))
        def el32enter(q):
            self.el3_2.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el3_3.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el3_4.setIcon(QtGui.QIcon('E:\monetka2.png'))
        ...
        def el35leave(q):
            self.el3_5.setIcon(QtGui.QIcon('E:\monetka.png'))
        def el41enter(q):
            self.el4_1.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_2.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_3.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_4.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_5.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_6.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_7.setIcon(QtGui.QIcon('E:\monetka2.png'))
        def el41leave(q):
            self.el4_1.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el4_2.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el4_3.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el4_4.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el4_5.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el4_6.setIcon(QtGui.QIcon('E:\monetka.png'))
            self.el4_7.setIcon(QtGui.QIcon('E:\monetka.png'))
        def el42enter(q):
            self.el4_2.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_3.setIcon(QtGui.QIcon('E:\monetka2.png'))
            self.el4_4.setIcon(QtGui.QIcon('E:\monetka2.png'))
...
class rules(QtWidgets.QWidget):
    def __init__(self):
        ...
        rules1.setFont(QtGui.QFont('Arial', 15))
